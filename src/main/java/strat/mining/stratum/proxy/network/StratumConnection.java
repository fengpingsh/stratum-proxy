...
public abstract class StratumConnection implements Connection {
    ...
    protected void onNotificationReceived(JsonRpcNotification notification) {
        ...
        case ClientReconnectNotification.METHOD_NAME:
            ...
            break;
        case ClientShowMessageNotification.METHOD_NAME:
            ClientShowMessageNotification showMessage = new ClientShowMessageNotification(notification);
            showMessage.setParams(notification.getParams());
    ...
    protected void onRequestReceived(JsonRpcRequest request) {
        ...
        case ClientShowMessageNotification.METHOD_NAME:
            ClientShowMessageNotification showMessage = new ClientShowMessageNotification();
            showMessage.setParams(request.getParams());
            onShowMessage(showMessage);
            break;
    ...
    /**
     * Called when a showMessage is received
     */
    protected abstract void onShowMessage(ClientShowMessageNotification showMessage);
